...
volatile boolean getMessage = true;
...
void loop() {
    ...
    if (receivedAck) {
        ...
        if (getMessage)
        {
          getMessage = false;
          message = "";
          DW1000.getData(message);//data, LEN_DATA);
...
//          Serial.println();
        ...
        else
        {
          ...
          DW1000.getData(data, LEN_DATA);//message);
          //message.getBytes(data,LEN_DATA);
          byte msgId = data[0];
